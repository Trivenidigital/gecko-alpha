...
Last updated: 2026-05-19 (cycle 15: overnight drift-cleanup audit — closed 13 stale items with inline evidence citations; 3 items annotated as STILL OPEN with elapsed-date flags)
...
**Closed in this audit (13 items, line numbers reflect post-edit positions):**
...
- BL-NEW-QUOTE-PAIR D+3 mid-soak (L413) — ELAPSED-WITHOUT-REVERT.
- BL-NEW-QUOTE-PAIR D+7 soak end (L414) — ELAPSED-WITHOUT-REVERT.
- Paper-lifecycle widening soak end (L420) — KEEP-ON-CONFIRMED per inline decision.
- PR #59 strategy tuning soak end (L421) — KEEP-ON-PERMANENTLY per inline decision; commit `3c83fb7`.
- gainers_early reversal re-soak 7d (L422) — ELAPSED-AUTO-SUSPENDED per `backlog.md:1797-1798`.
- PR #82 BL-NEW-MOONSHOT-OPT-OUT deploy (L426) — MERGED 2026-05-06; deploy state operator-responsibility.
- PR #59 duplicate re-check entry (L461) — duplicate of L421 head closure.
- BL-063 moonshot soak (L463) — duplicate of L419 head closure (already KEEP-ON-PERMANENTLY).
...
- narrative_prediction token_id divergence (L516) — duplicate of L521 head closure (PR #80 `eaf3523`).
...
**Still open at audit time (3 items, intentionally not closed; line numbers post-edit):**
...
- [x] **2026-05-04 22:24Z — Paper-lifecycle widening soak ends.** Sneak-peek +$1,234 net / 91 closes. Decision: keep on. **CLOSED 2026-05-19 (audit): KEEP-ON-CONFIRMED per inline sneak-peek decision; soak ended 15d before audit with no documented revert. .env continues to carry the widened lifecycle settings (see "Prod .env current state" block below in this same file).**
- [x] **2026-05-05 22:58Z — PR #59 strategy tuning soak ends.** Sneak-peek +$1,994 net / 135 closes / 67.4% win / 20% expired. Decision: keep on permanently. **CLOSED 2026-05-19 (audit): KEEP-ON-PERMANENTLY per inline decision + early-signal at 13.5h. PR #59 (`3c83fb7`) per `tasks/todo.md` "What shipped this session" table below. Soak ended 14d before audit; no documented revert.**
...
- [x] **2026-05-13+ — Deploy PR #82 BL-NEW-MOONSHOT-OPT-OUT (held overnight 2026-05-06).** Migration adds `signal_params.moonshot_enabled INTEGER NOT NULL DEFAULT 1` — no behavior change on deploy (default opt-IN preserves existing floor). Per-signal opt-out via `UPDATE signal_params SET moonshot_enabled=0 WHERE signal_type='X'`. Backtest applicability caveat: `findings_high_peak_giveback.md` PnL projection used floored regime; opted-out signal must re-run backtest with floor removed before projecting impact. **CLOSED 2026-05-19 (audit): MERGED 2026-05-06 (PR #82) per `tasks/todo.md:523` ("moonshot floor nullification — UPSTREAM FIX MERGED 2026-05-06"). Migration default-opt-IN means zero behavior change on deploy; per-signal opt-out remains operator-driven via `UPDATE signal_params`. Live deploy state on srilu is unverifiable in this docs-only audit (no SSH per audit scope).**
...
- [x] **PR #59 strategy tuning soak** — deployed 2026-04-28T22:58Z. Re-check window: 2026-05-05. **CLOSED 2026-05-19 (audit): KEEP-ON-PERMANENTLY (duplicate of L421 closure above in this file; same PR #59 / `3c83fb7`). 9× improvement in $/trade was the early-signal evidence; full-soak +$1,994 net / 135 closes / 67.4% win documented at L421. Soak ended 14d before audit; no documented revert.**
...
- [x] **BL-063 moonshot soak** — flag flipped 2026-04-27T13:58Z. Soak ends 2026-05-04T13:58Z. **CLOSED 2026-05-19 (audit): KEEP-ON-PERMANENTLY (duplicate of L419 closure above in this file). Per L419: "Moonshot path: 19 closes / +$2,232.86 net / +$117.52/trade / 100% win. Permanent." Soak ended 15d before audit.**
...
- [x] **Paper-lifecycle widening soak** — .env tweaks deployed 2026-04-27T22:24Z. Soak ends ~2026-05-04T22:24Z. **CLOSED 2026-05-19 (audit): KEEP-ON-CONFIRMED (duplicate of L420 closure above in this file). Soak ended 15d before audit; no documented revert.**
