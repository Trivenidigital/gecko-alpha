...
- Passing every gate does NOT authorize collection. No production command, host write, transport, deploy, SSH, DB, config, account, policy or vendor action in this slice.
