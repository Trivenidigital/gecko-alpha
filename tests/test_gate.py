...
async def test_gate_fires_above_threshold(mock_db, mock_session, settings_factory, token_factory):
...
async def test_gate_rejects_below_threshold(mock_db, mock_session, settings_factory, token_factory):
...
async def test_gate_boundary_exactly_70(mock_db, mock_session, settings_factory, token_factory):
...
async def test_gate_daily_cap_skips_mirofish(mock_db, mock_session, settings_factory, token_factory):
...
async def test_gate_below_min_score_skips_mirofish(mock_db, mock_session, settings_factory, token_factory):
...
async def test_gate_mirofish_fallback_on_timeout(mock_db, mock_session, settings_factory, token_factory):
